...
| INF-14 | Hébergement du rendu de l'Instrument sur `sidyvision.com` (Netlify, constaté le 2026-09-01) — un dépôt n'est pas une diffusion | `ouvert` | **verdicts rendus** (chemin `/instrument` ; INS-09 diffusé marqué suggéré) ; attend le visa du plan et le jeton Netlify. Le site n'a **aucune source versionnée** — capture de sauvegarde obligatoire avant toute manipulation | [[atelier/rd/infrastructure/inf-14-hebergement-rendu-sidyvision/intent]] | [[atelier/rd/infrastructure/inf-14-hebergement-rendu-sidyvision/intent]] complet | 2026-09-01 |
