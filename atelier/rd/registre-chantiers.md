...
| ID | Chantier | Statut | Prochaine action | Fiche d'origine | Ouvert par |
|---|---|---|---|---|---|
| PRO-01 | Protection de la branche `main` contournable sans review requise via l'API GitHub | `attente-verdict` | durcir ou acter — décision explicitement laissée à Sidy | registre des problèmes, entrée `[2026-08-29]` | 2026-08-29 |
