...
| OUT-20 | **Le wikilink court n'est gardé par rien** — la forme `[[slug]]` est admise par le §IV racine depuis le verdict du 2026-09-18 et repose tout entière sur l'unicité du basename dans le dépôt, qu'aucun contrôle ne vérifie ; mesure du jour : **589 occurrences dans 156 fiches, 0 ambiguïté** — mais une collision future changerait la cible d'un renvoi **silencieusement**, dans une fiche que personne n'édite | `attente-verdict` | **plan visé le 2026-09-18, étape 1 exécutée** : la mesure renverse la prémisse — **17 collisions de basename existent déjà entre circuits** (12 = stubs `deprecated` de la migration du 2026-08-08, 4 = paires `autorites/` ↔ `references/`, 1 = `album-personnel`), **aucune visée par un renvoi court** ; et le seul cas vivant du risque vient d'ailleurs : `_inbox/` a déposé un homonyme de `doctrinal/symboles/tariqa` le 2026-09-17, basename que **cinq fiches doctrinales** visent en forme courte. Restent les **deux verdicts** avant toute ligne de code — sévérité (un refus sec échouerait 17 fois dès la première exécution) et périmètre (`textes/` ajouterait 15 collisions par construction ; `_inbox/`, non prévu, est la vraie porte d'entrée) | [[atelier/rd/outillage/out-20-unicite-des-basenames/intent]] ; [[atelier/rd/outillage/out-20-unicite-des-basenames/spec]] ; [[atelier/rd/outillage/out-20-unicite-des-basenames/plan]] | 2026-09-18 |
