...
| OUT-20 | **Le wikilink court n'était gardé par rien** — la forme `[[slug]]` repose sur l'unicité du basename, qu'aucun contrôle ne vérifiait. Mesure du 2026-09-18 : 589 renvois courts dans 156 fiches, et **17 collisions de basename existant déjà** entre circuits (12 = stubs `deprecated` de la migration du 2026-08-08, 4 = paires `autorites/`↔`references/`, 1 = `album-personnel`), aucune visée par un renvoi court ; le seul cas vivant venait du sas (`_inbox/` doublant `doctrinal/symboles/tariqa`, visé par 5 fiches) | `resolu` | **B9 livré et éprouvé par l'échec le 2026-09-18** — refus conditionné à l'existence d'un renvoi court (verdict Sidy), périmètre = cinq circuits + `_inbox/`. Épreuve en quatre temps, copie jetable : vert sur sain ; refus sur homonyme fabriqué en circuit (B9 seul nomme la cause) ; refus sur homonyme fabriqué **dans le sas**, où B9 est le **seul** contrôle qui voit ; retour au vert. Remède appliqué au seul cas vivant : 8 renvois `[[tariqa]]` passés au chemin complet. Rien ne reste à faire | [[atelier/rd/outillage/out-20-unicite-des-basenames/intent]] ; [[atelier/rd/outillage/out-20-unicite-des-basenames/spec]] ; [[atelier/rd/outillage/out-20-unicite-des-basenames/plan]] | 2026-09-18 |
