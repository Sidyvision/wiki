...
| PRO-08 | **708 fichiers Markdown invisibles dans `raw/`** — `/raw/*` est dans `.gitignore`, donc tout le corpus converti (Guénon, Jurjani, Avalon, les deux Tilak à venir) **ne se synchronise pas vers Obsidian** : Sidy ne peut le lire que depuis le terminal. Constat de Sidy, 2026-09-02 : « aucun fichier Markdown n'a d'intérêt à rester en `raw/` » | `attente-verdict` | **instruit le 2026-09-02** (seconde voie, sur demande de Sidy) : triptyque écrit, mesures faites — 14 Mo de texte contre 2,6 Go de binaires, **zéro donnée personnelle**, 147 doublons. Trois verdicts attendus : le nom du dossier, le sort des doublons, l'amendement du §II | `.gitignore` ; `_inbox/MASTER-UPDATE.md` §6 question 4 | [[atelier/rd/infrastructure/pro-08-textes-convertis-versionnes/intent]] | 2026-09-02 |
