...
| [[lumiere-hindouisme-soufisme]] | Hindouisme et Soufisme (Shayegan) — chapitre IV « La Lumière » (commentaire du ch. IX du *Majmaʿ al-Bahrayn*), p.155-167 | `raw/La Lumière - Daryush Shayegan/` 8 clichés + `IV.md` (texte déjà transcrit en `raw/`) | intégré — **transcription brute non relue** : scories de reconnaissance connues (« Dara Shokah », « bénuriciant », césures non recollées, numérotation romaine dégradée « 1l1) », « [v) ») ; diacritiques sanskrits/persans `to-verify` sur cliché |
