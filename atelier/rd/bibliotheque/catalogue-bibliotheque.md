---
title: "Catalogue de la bibliothèque physique de travail"
type: ressource
...
# Catalogue de la bibliothèque physique de travail

> **Déplacement du 2026-08-22 (verdict Sidy).** Cette fiche vivait en
> `meta/bibliotheque-physique.md`. Elle rejoint `atelier/rd/bibliotheque/` :
> un catalogue d'ouvrages disponibles au travail n'est pas un fait personnel,
> et en `meta/` aucun circuit ne pouvait le citer (le Domaine Réservé ne reçoit
> aucun lien entrant). Un tombstone `deprecated` reste à l'ancien chemin (Cmd 10).
> `doctrinal/` ne lie jamais vers `atelier/` : la consultation prévue par §VII
> reste une consultation humaine, sans wikilink — inchangée.

> Recension établie par lecture de photographies des tranches (étagère par étagère),
> revue et validée par Sidy (2026-06-28). Cette page sert de réservoir pour le champ
> **Lectures suggérées** des fiches `doctrinal/discernement/` et des rapports VIGILANCE.
> Statut par défaut : `confirmé` (lecture directe attestée). Le tag `#a-revoir` signale les
> entrées combinant plusieurs métadonnées (traducteur + commentateur + tome) à recroiser au
> besoin — il n'invalide pas l'usage immédiat de l'entrée comme lecture suggérée.

---

## I. Métaphysique pure, Tradition Primordiale, études hindoues

*Axe vertical immuable de l'instrument — exposés des principes suprêmes et critique des
déviations modernes.*

### René Guénon
- *Introduction générale à l'étude des doctrines hindoues* (Éditions Véga) — rejet des lectures occidentalisantes.
- *L'Homme et son devenir selon le Vêdânta* (Éditions Traditionnelles) — ontologie de l'être humain au-delà du contingent.
- *Le Symbolisme de la Croix* (Éditions Véga) — articulation axe vertical/plans horizontaux, directement pertinent pour l'architecture 3D.
- *Les États multiples de l'être* (Éditions Véga) — formalisation des degrés ontologiques.
- *La Grande Triade* (Gallimard) — clé d'interprétation extrême-orientale, ternaires cosmiques.
- *Le Roi du Monde* (Gallimard) — Centre Suprême, Tradition Primordiale.
- *L'Ésotérisme de Dante* (Gallimard) — symbolisme spatial, structures initiatiques occidentales.
- *Symboles de la Science sacrée* (Gallimard) — lexique formel pour l'iconographie du mandala.
- *Aperçus sur l'Initiation* (Éditions Traditionnelles) — conditions de la réalisation spirituelle.
- *Initiation et Réalisation spirituelle* (Éditions Traditionnelles) — complément du précédent.
- *Autorité spirituelle et Pouvoir temporel* (Guy Trédaniel) — rapports hiérarchiques connaissance/action.
...
- **Daryush Shayegan** — *Hindouisme et Soufisme : une lecture du «Confluent des Deux Océans»* (Albin Michel, coll. « La Pensée et le Sacré », ISBN 2-226-08900-4) — étude comparatiste mettant en regard hindouisme et soufisme à travers le *Majmaʿ al-Bahrayn* (« Confluent des deux mers ») du prince moghol Dârâ Shokûh (1615-1659) — rapprochement **CONFIRMÉ en bibliothèque physique** (2026-08-27, table analytique des matières + quatrième de couverture, qui nomme explicitement « Le Majmaʿal-Bahrayn de Dârâ Shokûh »). Rang et année d'édition non relevés (une « Préface à la deuxième édition » atteste au moins une réédition, date non lisible sur les clichés) ; aucun traducteur distinct crédité — l'ouvrage semble une composition/traduction-commentaire de Shayegan lui-même — `#a-revoir` maintenu pour ce seul point (édition/année). Couverture, table analytique et liste des abréviations transcrites : [[sommaire-hindouisme-soufisme]], [[abreviations-hindouisme-soufisme]]. Pertinence directe pour le dossier comparatisme védique/hindou-soufi (cf. Tilak, ci-dessus).

---

## II. Tasawwuf (Soufisme) et ésotérisme islamique

*Tradition pilote du wiki.*
...
- *Le Traité du nom Allâh* (trad. M. Gloton)
- *Le Mahdi et ses Conseillers* (trad. C.-A. Gilis)
...
- **Louis Massignon** — *La Passion de Hallâj* (Gallimard/Tel, Vol. II)
- **Seyyed Hossein Nasr** — *L'Islam traditionnel face au monde moderne* (L'Âge d'Homme)
- **Sulamî** — *Femmes soufies*
- **Sheikh Nâzim al-Haqqânî** — *Océans de Miséricorde, Vers la Présence divine* (Tomes 1 & 2)
- **Didier Hamoneau** — *Vie et Enseignement du Cheikh Ahmadou Bamba*
- **Tariq Ramadan** — *Mon intime conviction*
- **Razia Grover** — *Les Mosquées*
- *La Philosophie des Ihwān al-Ṣafā'* (Épîtres des Frères de la Purete) `#a-revoir` — auteur, traducteur et editeur a confirmer sur l'exemplaire (metadonnees non encore relevees). Index et glossaire photographies : `raw/La Philosophie des Ihwan al-Safa` (34 vues). (Omission de recension initiale, ajoute 2026-08-22)

---

## III. Orient, écritures sacrées et traditions occidentales

*Formes traditionnelles nécessaires aux correspondances et scaffolds horizontaux.*

- *La Sainte Bible / Thora et Haftarot* (éd. bilingue hébreu-français) — assise formelle de la tradition hébraïque, indispensable pour l'arbre de la Kabbale.
- *La Bhagavad Gîtâ* (comm. Swami Chinmayananda, Trédaniel)
...
## IV. Sciences traditionnelles, cosmologie et art sacré

*Applications contingentes (géométrie, cycles historiques, symbolisme naturel) — pertinent pour l'ergonomie et les visuels de l'app.*
...
## V. Littérature, politique, documents divers (hors-cadre doctrinal)

*Conservés pour d'autres projets non-doctrinaux — n'alimentent pas les Lectures suggérées du circuit `doctrinal/`.*
...
le tag invite seulement à un recroisement futur, sans urgence.*
...
(`index-<slug>.md`). Elles ne portent aucun contenu doctrinal — seulement
terme → page. Usage : savoir *où chercher*, notamment pour préparer la levée
d'un `to-source` (la levée elle-même reste la vérification du texte primaire
par Sidy, §VII — l'index dit où regarder, jamais quoi conclure).

Lexique unifié dérivé : `glossaire-unifie.md`, régénéré par
`generer-glossaire-unifie.py` — artefact dérivé, jamais édité à la main.

| index | ouvrage | photos | état |
|---|---|---|---|
| [[index-rig-veda-table]] | Rig-Véda (Langlois, trad. Foucaux) | IMG_0092-0093 (2) | intégré |
| [[index-rig-veda]] | Rig-Véda (Langlois, trad. Foucaux) | IMG_0094-0104 (11) | intégré |
| [[introduction-ihwan-al-safa]] | La philosophie des Ihwān al-Ṣafā' (Marquet) | IMG_9975-9986 (12) | intégré — lacune p.VI non photographiée |
| [[bibliographie-ihwan-al-safa]] | La philosophie des Ihwān al-Ṣafā' (Marquet) | IMG_9987-9995 (9) | intégré |
| [[index-noms-ihwan-al-safa]] | La philosophie des Ihwān al-Ṣafā' (Marquet) | IMG_9996-9999 (4) | intégré |
| [[index-notions-ihwan-al-safa]] | La philosophie des Ihwān al-Ṣafā' (Marquet) | IMG_0001-0004 (4) | intégré |
| [[table-ihwan-al-safa]] | La philosophie des Ihwān al-Ṣafā' (Marquet) | IMG_0005-0008 (4) | intégré |
| [[sommaire-porte-du-ciel]] | La Porte du Ciel (Coomaraswamy) | IMG_0010-0012 (3) | intégré — signale deux lacunes majeures (Préface p.9-18, essais p.37-281) |
| [[preface-introduction-porte-du-ciel]] | La Porte du Ciel (Coomaraswamy) | IMG_0013-0028 (24) | intégré — Préface Snodgrass (p.9-18) non photographiée |
| [[glossaires-porte-du-ciel]] | La Porte du Ciel (Coomaraswamy) | IMG_0029-0057 (29) | intégré — page 314 (transition glossaire/index) non photographiée |
| [[index-noms-porte-du-ciel]] | La Porte du Ciel (Coomaraswamy) | IMG_0057-0070 | intégré — détail exhaustif des entrées `to-verify` (synthèse partielle) |
...
| [[eckstein-porte-du-ciel]] | La Porte du Ciel (Coomaraswamy) — essai « Eckstein », p.169-179 | `raw/Eckstein - La Porte du Ciel/` IMG_0254, 0258-0262 (6) | intégré — premier essai du corps p.37-281 photographié ; signalement ajouté dans `doctrinal/discernement/2026-07-07_sashimono-metier-traditionnel.md` |
| [[symbolisme-du-dome-porte-du-ciel]] | La Porte du Ciel (Coomaraswamy) — essai « Le Symbolisme du Dôme », p.39-94 | `raw/Le symbolisme du dôme -La Porte du Ciel/` IMG_0263-0291 (29) | intégré — essai directement commenté par Guénon (ch. XXXIX-XL, *Symboles de la Science sacrée*) ; signalement ajouté dans la même fiche discernement |
| [[guenon-symbolisme-du-dome-et-dome-roue]] | Symboles de la Science sacrée (Guénon) — ch. XXXIX-XL | `raw/Symboles de la Science sacrée, René Guénon/` (texte `.md` déjà transcrit, pas de photo) | intégré — fiche de repérage, texte primaire directement consultable en `raw/` |
| [[manifeste-corpus-symboles-science-sacree]] | Symboles de la Science sacrée (Guénon) — corpus complet | `raw/Symboles de la Science sacrée - René Guénon/` 92 clippings web (2026-08-30, dont le ch. XX ajouté par Sidy en cours de session) | intégré — manifeste mécanique, **couverture 100 % (75/75 chapitres)** ; ch. XVIII et XXXVII (Janus) traités en fiches `doctrinal/sources/` dédiées ce jour, le reste `candidat non traité` |
...
| [[sommaire-hindouisme-soufisme]] | Hindouisme et Soufisme (Shayegan) | 5 clichés (couverture recto+verso ; table d'ensemble ; p.278-279 ; p.280-281) | intégré — lot fragmentaire : corps de texte p.7-268, page de titre légale et bibliographie (p.269) non photographiés ; 2 numéros de page `to-verify` (netteté) |
| [[abreviations-hindouisme-soufisme]] | Hindouisme et Soufisme (Shayegan) | 2 clichés (p.9-10) | intégré |
| [[lumiere-hindouisme-soufisme]] | Hindouisme et Soufisme (Shayegan) — chapitre IV « La Lumière » (commentaire du ch. IX du *Majmaʿ al-Bahrayn*), p.154-167 | `raw/La Lumière - Daryush Shayegan/` 8 clichés + `IV.md` (texte déjà transcrit en `raw/`) | intégré — **relue et corrigée sur les 8 clichés** (2026-08-29) : nom d'auteur uniformisé, césures recollées, numérotation romaine restituée, appareil de notes (p.167) recomposé 1-23 |
| [[majma-al-bahrayn-hindouisme-soufisme]] | Hindouisme et Soufisme (Shayegan) — texte traduit du *Majmaʿ al-Bahrayn*, p.18-50 | `raw/Majma' Al-Bahrayn/` IMG_0318-0330 (13) | intégré — **transcription OCR brute non relue** (qwen3.7-plus) : en-têtes courants fautifs (« HINDOUISE », « HINDOUISEME ») sur 3 pages, italiques inégales, diacritiques `to-verify` ; appareil de notes jusqu'à la note 70 |
| [[quatre-mondes-hindouisme-soufisme]] | Hindouisme et Soufisme (Shayegan) — chapitre III « Les Quatre Mondes » (commentaire du ch. VII du *Majmaʿ al-Bahrayn*), p.121-151 | `raw/Les Quatre Mondes - Daryush Shayegan/` 16 clichés + `.md` (texte déjà transcrit en `_inbox/`) | intégré — **relue et corrigée sur les 16 clichés** (2026-08-29) ; réserve sur la seule page de titre non numérotée (cliché en rotation, la moins nette du lot) ; appareil de notes (p.151) recomposé 1-71. Correspondance Ḥaḍarāt/états-d'Âtmâ (§III du chapitre) signalée à l'Instrument, voir la fiche |
| [[disciplines-spirituelles-hindouisme-soufisme]] | Hindouisme et Soufisme (Shayegan) — chapitre II « Les Disciplines Spirituelles » (commentaire du ch. III du *Majmaʿ al-Bahrayn*), p.95-120 | `raw/Les Disciplines Spirituelles - Daryush Shayegan/` 13 clichés IMG_0349-0361 | intégré — **transcription OCR brute NON relue** (2026-08-30) : lignes d'en-tête garbled en tête de fichier, mots coupés, artefact horaire isolé. Pagination frontmatter (« p.240 ») corrigée à p.95-120. Signalement pur (Cmd 3) : liste ordonnée des sept *laṭāʾif*/régents (Semnânî) et des sept *cakra* toutes deux présentes, mais **non mises en correspondance terme à terme par Shayegan lui-même** |
...
à Delphes », note sur le coq, « Le Pont périlleux du Bonheur », « Symplégades »,
les 4 Appendices) : non photographiés, aucune fiche — en attente de nouvelle prise
de vue (voir [[sommaire-porte-du-ciel]]).
