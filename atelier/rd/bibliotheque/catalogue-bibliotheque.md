...
| [[manifeste-corpus-symboles-science-sacree]] | Symboles de la Science sacrée (Guénon) — corpus complet | `raw/Symboles de la Science sacrée - René Guénon/` 91 clippings web (2026-08-30) | intégré — manifeste mécanique, 74/75 chapitres de la table des matières couverts (seul le ch. XX « Sheth » absent) ; ch. XVIII et XXXVII (Janus) traités en fiches `doctrinal/sources/` dédiées ce jour, le reste `candidat non traité` |
