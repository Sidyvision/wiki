...
> `atelier/projets/spec-anneau-zodiacal.md` vers `atelier/rd/instrument/spec-anneau-zodiacal.md` (ouverture du pôle R&D,
...
```javascript
// ── Anneau zodiacal ────────────────────────────────────────────────────────────
// Spec : atelier/rd/instrument/spec-anneau-zodiacal.md
