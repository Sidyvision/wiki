...
updated: 2026-07-01
sources: []
links: ["[[atelier/projets/instrument-tradition-primordiale-architecture-v0.3]]", "[[doctrinal/symboles/hadarat-khams]]", "[[doctrinal/symboles/table-28-degres-nafas-rahman]]"]
---
...
> figé dans la fiche architecture v0.3 §6) à partir de `doctrinal/` et d'un fichier
...
- **Moteur 3D** : Three.js / WebGL (question §8.3 de la fiche v0.3 — tranchée).
...
- un ancrage `subversion` ou `parodie` porte une `cible` non nulle **sans** que sa
  ...
  fiche v0.3 §2 et §6 — jamais de pont inter-traditions structurel par défaut).
...
traitement de nœud *traversant* les cinq Présences (fiche v0.3 §3.4) relève du rendu
