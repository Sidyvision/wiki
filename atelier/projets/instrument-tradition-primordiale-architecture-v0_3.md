...
**Générateur livré (2026-07-01, Phase 1)** : `atelier/projets/generer-manifeste.py`
...
`atelier/projets/instrument-donnees.yaml` (nœuds, degrés, ancrages). Spécification :
`atelier/projets/spec-generateur-manifeste.md`. Premiers ancrages `etabli` inscrits :
