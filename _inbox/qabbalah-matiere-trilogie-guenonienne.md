---
title: "Matière kabbalistique dans la trilogie guénonienne (session 2026-07-16) : point primordial, Palais intérieur, Adam Qadmôn, Kether/Aïn-Soph"
type: source
status: traditionnel
...
- Le **point caché** (la lettre ***iod***) naît dans ce mystère : l'éther rendu
  ...
  l'alphabet hébraïque — formation qui symbolise celle du monde manifesté. Si l'on
  enlève le *iod* du mot *Avir* (éther), il reste *Aor* (lumière).
- Le point primordial forme trois points (Commencement, Milieu, Fin) réunis dans le
  *iod* — l'Un manifesté. Comparés par Guénon (note) aux trois éléments du monosyllabe
  *Aum*.
- Du point caché émane le Saint Palais intérieur **par les lignes issues de ce point
...
- Concordance temporelle : six millénaires (six jours de la création) + le septième
  (Sabbath) = retour au Principe, centre comme septième « région ».
- Note de Guénon : les « colonnes » de l'**arbre séphirothique** (milieu, droite,
  gauche) sont mentionnées comme devant être traitées « plus loin » dans le livre —
  chapitre non encore transcrit dans ce dépôt.

## 3. Kether comme « vêtement » d'Aïn-Soph (Homme et son devenir, ch. X, note 9)
...
## 4. Éléments épars déjà rencontrés en session (rappel de localisation)

- Les « trois mondes » de la Qabbalah (*Beriah* manifestation informelle, *Ietsirah*
  manifestation subtile, *Asiah* manifestation grossière) mis en correspondance exacte
  avec le *Tribhuvana* hindou (Symbolisme de la Croix, ch. IV, note 17, renvoyant à
  *L'Homme et son devenir*, ch. V — non transcrit).
- La *Shekinah* (« présence divine ») manifestée dans le Tabernacle (*mishkan*),
  partie la plus intérieure du Temple (ch. IV, note 29).
...
méthode de Sidy, 2026-07-16). Néanmoins : (a) la matière kabbalistique de Guénon passe
ici par des sources secondaires (Vulliaud) — degré de médiation supplémentaire par
rapport aux citations akbariennes directes ; (b) **aucun de ces éléments ne doit entrer
dans `instrument-donnees.yaml` sans fiche de discernement dédiée** fixant précisément
quels nœuds/ancrages kabbalistiques sont retenus et sur quel texte ; (c) l'arbre
séphirothique complet (dix Sephiroth, trois colonnes, sentiers) n'est PAS documenté
dans cette fiche — seuls Kether, Aïn-Soph et la cosmogonie du point y figurent. Un
versant Kabbale de l'Instrument exigerait sa propre fondation (équivalent de
*hadarat-khams*), non encore constituée.

## Fiabilité de la source

Consolidation de transcriptions transmises par Sidy (2026-07-16,
index-rene-guenon.org). Matière guénonienne de seconde main (Vulliaud, *La Kabbale
juive*) pour la partie Sepher Ietsirah/Moïse de Léon. Non recoupée sur textes
kabbalistiques primaires.

## Utilisation dans le dépôt

Base de départ pour un éventuel versant Kabbale de l'Instrument (troisième branche de
l'Arbre unique, après Tasawwuf et le futur Sanātana Dharma), et pièce d'appui pour
l'équivalence Adam Qadmôn = al-Insān al-Kāmil, directement pertinente au filament déjà
rendu dans le prototype.
