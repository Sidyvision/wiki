---
title: "CLAUDE.md — Protocole du Dépôt V5 (version pré-amendement §II, archivée)"
type: meta
status: deprecated
created: 2026-09-15
updated: 2026-09-15
...
# ⚠️ Version archivée — pré-amendement du §II (2026-09-15)

État du protocole racine **avant** l'amendement de la règle d'immuabilité de
`textes/` (§II), rendu par Sidy le 2026-09-14 et porté au protocole le 2026-09-15.
Le §II y porte encore la rédaction à plat : « un texte de `textes/` ne se corrige
pas. Une conversion meilleure le remplace, datée. » Conservée intégralement pour
rollback (Commandement 10 : jamais de suppression sèche). En cas de retour arrière,
ce fichier fait à nouveau foi tel quel comme `CLAUDE.md` racine.

Amendement consigné en `meta/protocole-archives/changelog-CLAUDE.md`, entrée
`[2026-09-14] amendement | §II — Règle d'immuabilité de textes/`. Rédaction visée :
