---
title: "CLAUDE.md — Protocole du Dépôt V4 (version pré-extraction, archivée)"
type: meta
status: deprecated
created: 2026-09-09
updated: 2026-09-09
...
# ⚠️ Version archivée — pré-extraction Phase 2 (2026-09-09)

État du protocole racine **après** la consolidation Phase 1 (audit Qoder R1–R4) et
**avant** l'extraction en `protocoles/` (Phase 2, amendement du Cmd 14, verdict Sidy du
2026-09-09). Conservée intégralement pour rollback (Commandement 10 : jamais de
suppression sèche). En cas de retour arrière, ce fichier fait à nouveau foi tel quel
comme `CLAUDE.md` racine.
