...
- [[doctrinal/sources/xi-you-ji-wu-chengen|Xī Yóu Jì 西遊記 — le Voyage en Occident (Wú Chéng'ēn)]] — roman Ming, cent 回 ; `profane` **à titre de proposition** (verdict de statut et de `tradition_cadre` ouverts) ; exemplaire du dépôt **défectueux** — 13 titres sur 100 s'écartent du témoin 維基文庫, dont 5 pertes de matière, et le corps n'est collationné avec rien ; lexique *nèidān* relevé par mesure dans les titres (`心猿` 17 fois, `木母` 7)
