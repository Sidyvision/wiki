...
> « La vérité est une ; les formes sous lesquelles elle se manifeste sont multiples. »

Catalogue organisé par Principes, puis par Formes traditionnelles et Autorités. À tenir synchronisé avec les fichiers réels du dossier `doctrinal/`.

---

## I. Les Formes Traditionnelles (`traditions/`)
...
## II. Les Principes et les Symboles (`symboles/`)
...
- [[doctrinal/symboles/devayana-pitriyana|Dêva-yâna et pitri-yâna — les deux voies, et les deux moitiés du cycle]] — `traditionnel`. Le couple était nommé au dépôt **sans y avoir de page**. Charpente guénonienne : les portes solsticiales donnent accès aux moitiés **ascendante et descendante**, et leurs deux clefs sont « sous un autre rapport » celles des **grands** et des **petits mystères** (or / argent). Signes de la *Bhagavad-Gītā* : les deux **semestres** du soleil. Versant védique `academique` distingué dans le corps. 🔍 Au pôle, les deux moitiés sont un seul jour et une seule nuit — coïncidence **nommée, non tranchée** (Cmd 12)
- [[doctrinal/symboles/adityas-mois-du-soleil|Les Ādityas — les états du soleil, et le huitième rejeté]] — `academique`, `to-source`. **Trois listes distinctes, non fondues** : les huit fils d'Aditi (RV X, 72) avec **Mārtāṇḍa rejeté** ; les huit soleils du *Taittirīya Āraṇyaka*, dont **Kaśyapa qui ne quitte jamais le Mahāmeru** et donne sa lumière aux sept visibles ; et 🌐 les **douze** du *Śatapatha*, identifiés aux douze mois. ⚠️ Le texte **ne dit pas lequel des huit est Mārtāṇḍa** — lacune conservée, non comblée. ⚠️ Interdit posé : ne pas rapprocher les **trois septénaires** (Ādityas solaires, Ṛṣis stellaires, Aqtāb planétaires)
- [[doctrinal/symboles/ushas-les-trente-aurores|Uṣas et les trente aurores — l'aurore au pluriel dans le Ṛg-Veda]] — `academique`, `to-source`. *Uṣas* / *Vyuṣṭi* ; division par trois ou par cinq ; **trente sœurs continues, non séparées**, dites ailleurs **trente marches d'une seule aurore** — deux aspects du même fait, le dépôt ne choisit pas. Mouvement **rotatoire, comme une roue**. ⚠️ Écart **laissé visible** : le nombre trente vient du texte, la durée du seuil crépusculaire (Tilak : « matière d'incertitude ») — les ajuster fabriquerait un accord que les sources ne donnent pas
...
- [[doctrinal/autorites/al-khwarizmi|Al-Khwārizmī]]
- [[doctrinal/autorites/ouattara-brahima|Ouattara Brahima (traducteur, Tijāniyya)]]
- [[doctrinal/autorites/abd-al-qadir-al-jilani|ʿAbd al-Qādir al-Jīlānī (le Ghawth al-Aʿẓam)]]
- [[doctrinal/autorites/abd-al-karim-al-jili|ʿAbd al-Karīm al-Jīlī]]
...
## V. Les Études Transversales (`etudes/`)
...
- [[doctrinal/sources/xi-you-ji-wu-chengen|Xī Yóu Jì 西遊記 — le Voyage en Occident (Wú Chéng'ēn)]] — roman Ming, cent 回 ; `traditionnel`, cadre `taoisme` — **verdict Sidy du 2026-09-16** (la fiche avait été ouverte la veille en `profane`/`none`, proposition réservée) ; exemplaire du dépôt **défectueux** — 13 titres sur 100 s'écartent du témoin 維基文庫, dont 5 pertes de matière, et le corps n'est collationné avec rien ; lexique *nèidān* relevé par mesure dans les titres (`心猿` 17 fois, `木母` 7)
...
- [[doctrinal/sources/burckhardt-introduction-doctrines-esoteriques-islam|Introduction aux doctrines ésotériques de l'Islam (Burckhardt, ch. II)]]
...
- [[doctrinal/sources/guenon-etats-multiples-ch3-10-11-12-distinction-des-etats|Les états multiples de l'être, ch. III, X, XI, XII : Être et Non-Être, confins de l'indéfini, principes de distinction, les deux chaos (Guénon)]] — ⚠️ `to-source` ; **l'Être n'est pas infini** (seul l'ensemble Être+Non-Être l'est) ; le couple **ampleur / exaltation**, où un état entier se réduit à **un point** sur l'axe vertical ; **le plan de base est indéterminé en principe** — rapporter les états à l'état humain est « assurément légitime » mais reste « un point de vue très particulier » ; Eaux supérieures/inférieures et la **surface des Eaux** comme plan de réflexion du Rayon Céleste
...
- [[doctrinal/sources/tilak-orion-antiquite-vedas-1893|The Orion, ou Recherches sur l'antiquité des Vêdas (Tilak, 1893)]] — `academique`. Le **premier** ouvrage de l'auteur, dix ans avant *Arctic Home* : il établit la méthode que l'autre pousse à l'extrême. Retenu pour la **précession comme chronomètre** et pour la distinction entre **repère principiel immuable** (le pôle) et **horloge cyclique** (l'écliptique). ⚠️ Ses quatre périodes datées (Pré-Orion, Orion, Krittikā, Pré-bouddhique) **ne sont pas adoptées**. 🌐 Les Pléiades y sont un repère de DATE — à ne pas confondre avec le partage Grande Ourse / Pléiades du *Roi du Monde*, qui est un partage entre deux TRADITIONS
...
- [[doctrinal/sources/guenon-symbolisme-croix-ch26-27-incommensurabilite-place-etat-humain|Le Symbolisme de la Croix, ch. XXVI-XXVII : incommensurabilité de l'être total et place de l'état humain (Guénon)]] — ⚠️ `to-source` (édition du clipping ≠ exemplaire) ; l'incommensurabilité y est dite **absolue, ne dépendant d'aucune convention**, et **dérivée d'une différence de dimension** (un état est une surface, l'être total un volume) ; « le symbolisme descend et ne remonte point » (Matgioi) ; l'état humain n'a **aucun rang privilégié** et son rang nous est **inconnaissable** ; signalement d'une **troisième numérotation** de *L'Homme et son devenir* (renvois « 3ᵉ éd. »)
- [[doctrinal/sources/guenon-symbolisme-croix-ch5-trois-gunas|Le Symbolisme de la Croix, ch. V : la théorie hindoue des trois gunas (Guénon)]] — ⚠️ `to-source` ; les guṇas sont des **conditions**, non des états ; *sattva* = verticale supérieure, *rajas* = plan horizontal, *tamas* = verticale inférieure — correspondance géométrique **explicite chez Guénon** ; et la répartition est **relative à l'état pris pour base**
...
- [[doctrinal/sources/guenon-homme-devenir-vedanta-ch15-21|L'Homme et son devenir selon le Vêdânta, ch. XV-XXI en 1ʳᵉ éd. (= XIV-XX de l'exemplaire) (Guénon)]] — ✅ attributions **résolues** le 2026-08-30 : l'ouvrage existe en deux états (1ʳᵉ éd. 26 ch., éd. ultérieure 24 ch.), table de concordance portée dans la fiche ; les sections établies sur paraphrase restent conservées mais non fiables quant à leur numérotation
- [[doctrinal/sources/guenon-homme-devenir-vedanta-ch20-artere-coronale-rayon-solaire|L'Homme et son devenir selon le Vêdânta, ch. XX (= XXI en 1ʳᵉ éd.) : L'artère coronale et le « Rayon solaire » (Guénon)]] — texte primaire ; les 101 nâdîs issues du cœur « comme les rais d'une roue », le ternaire temporel des canaux (futur/présent/passé), l'identité du symbolisme à *Janus Bifrons* posée par Guénon, et le Rayon solaire qui prolonge l'axe au-delà de l'individu en portant le même nom que lui
- [[doctrinal/sources/transcription-table-matieres-homme-devenir-vedanta|Transcription — Table des matières de *L'Homme et son devenir selon le Vêdânta* et concordance des deux éditions]] — collationnée sur l'exemplaire (24 ch.) ; **règle de conversion** avec l'index web (1ʳᵉ éd., 26 ch.) : web XII-XXIV = exemplaire −1, web XXVI = XXIV. Un numéro de chapitre de cet ouvrage n'a pas de sens seul
...
- [[doctrinal/sources/manifeste-corpus-symboles-science-sacree|Manifeste du corpus raw/ — Symboles de la Science sacrée (Guénon)]] — mappage mécanique des 92 clippings vers les 75 chapitres de la table des matières ; couverture 100 % (75/75), 8 en-têtes de section + 1 annexe identifiés à part
...
- [[doctrinal/sources/guenon-apercus-initiation-ch20-magie-ceremonielle|Aperçus sur l'Initiation, ch. XX : à propos de « magie cérémonielle » (Guénon)]] — critère décisif : la transmission, jamais la correction technique
- [[doctrinal/sources/guenon-hermetisme-hermes-thoth|Aperçus sur l'Initiation, ch. XLI : Quelques considérations sur l'hermétisme — Hermès identifié au Thoth égyptien (Guénon)]] — renfort du deuxième maillon de [[doctrinal/discernement/2026-08-25_gizeh-degre-24-solaire-hermes-idris]]
- [[doctrinal/sources/guenon-symbolisme-croix-ch17-ilm-al-huruf|Le Symbolisme de la Croix, ch. XVII, note 3 : les trois degrés de la science des lettres (Guénon)]] — seule occurrence d'*ilmul-hurûf* dans le corpus disponible
...
- [[doctrinal/discernement/2026-09-10_tabernacle-honden-interiorite|Tabernacle, Saint des Saints et honden — examen d'un rapprochement d'intériorité]] 🔍 (en cours, speculatif) — rapprochement proposé par Sidy à partir de son expérience du *shimenawa*. Le joint le plus solide n'est **pas** le Temple bâti mais le **Tabernacle** (*mishkan*, portable), qui répond au *himorogi* shintō : dans les deux cas l'**enclos précède l'édifice** et la structure irréductible est **une bordure et un centre**. Qualification sashimono : **kari-kumi**. Trois asymétries portées : le *honden* est **facultatif** (*shintaizan*, mont Miwa) là où le *debir* est constitutif ; la **doctrine du centre** (six directions, septénaire) est explicite chez Guénon et **absente** de la description du *honden* ; vigilance « jeu de piste » (clôture narrative non falsifiable) déjà signalée sur le couple Torii/Miḥrāb. ⚠️ **Conflation polaire/solaire refusée** : le récit d'institution du *shimenawa* est solaire (Amaterasu), non polaire — résultat consigné négatif. Volet abrahamique tenu par une **seule note** du dépôt (Tabernacle *in* [[doctrinal/sources/qabbalah-matiere-trilogie-guenonienne]], elle-même *kari-kumi*) : `to-source` sur tout texte biblique, non transcrit
...
- [[doctrinal/discernement/2026-08-30_kursi-qadaman-hokhmah-binah-premiere-polarisation|Le Kursī et les deux Pieds (qadamān) au regard de Hokhmah et Binah — la première polarisation]] — **close (traditionnel), verdict Sidy 2026-08-30 : joint ***kumiko*** approuvé** (complémentarité, non équivalence), portance *jikugumi*, nature homologie — hypothèse de Sidy (2026-08-30) : le Kursī au **degré 18**, où « les deux Pieds se posent » et que Gloton nomme « la **première polarisation** pour que la manifestation formelle se produise », et le couple **Hokhmah/Binah**, premier dédoublement de l'Arbre sous Kether, nommeraient le même moment structurel. Établi sur texte primaire photographié des deux côtés ; **aucun auteur ne pose le rapprochement** — il est de Sidy, et les trois objections du §4 bornent la portée du verdict sans être réfutées par lui. **Report en donnée non décidé** : un ancrage fermerait un triangle de transitivité avec l'ancrage Hokhma↔Ājñā déjà établi. Distingué explicitement de la version déviée par gématrie conservée en [[doctrinal/symboles/merkavah-muraqaba]]
...
- [[doctrinal/discernement/2026-08-29_sept-poles-sept-lataif|Les sept Pôles et les sept laṭāʾif]] — validée dans son principe par Sidy (2026-08-29), appuyée par la correspondance des Noms avec les prophètes qui en sont les régents ; obstacle de forme levé par la distinction des deux échelles (bloc ⚠️) ; table de correspondance *cakra*↔*laṭīfa* construite et **maintenue en *kari-kumi*** (verdict Sidy, 2026-08-30)
...
- [[doctrinal/discernement/2026-08-30_nadis-du-coeur-sentiers-sephirothiques-tiferet|Les nâdîs issues du cœur et les sentiers séphirothiques émanant de Tiferet]] 🔍 (**lecture *kumiko* approuvée par Sidy le 2026-08-30** ; « de quel cœur » reste en cours, `speculatif`) — hypothèse de Sidy (2026-08-30) ; deux appuis réels (voies rapprochées de voies, et le cœur déjà posé des deux côtés — Tiferet est « Cœur de l'Arbre » dans le dépôt), **instruite deux fois le même jour**, les deux examens conservés. Premier : trois obstacles, dont « l'inversion du lettrique ». Second (invitation de Sidy à jouer des points de vue plutôt qu'à retourner aux sources) : **les trois obstacles tombent, deux se retournent en appuis, sans aucune source nouvelle** — Avalon dit lui-même que « les pétales sont des figures formées par la position des Nâdî », donc les lettres sont sur les **canaux** des deux côtés, et l'inversion n'existait pas. Lecture proposée : l'Arbre est une **élévation**, les lotus des **plans** — deux projections d'un même réseau, chacune portant ce qui manque à l'autre. La litote de Guénon (« pas sans analogie ») devient dès lors le **mot juste**. Nature proposée : ***kumiko*** et non *hozo*, **ce qui conforte l'hypothèse**. Une prédiction structurelle falsifiable est posée pour plus tard (degré de chaque Sephirah ↔ nombre de pétales), avec ses trois précautions ; aucun comptage produit
...
- [[doctrinal/discernement/2026-08-13_shams-al-maarif-efficacite-talismanique-critere-psychique-spirituel|L'efficacité talismanique du Shams al-Maʿārif face au critère psychique/spirituel guénonien]] 🔍 (en cours, speculatif) — premier axe du chantier de confrontation Shams al-Maʿārif/Guénon ; critère « les manifestations phénoméniques ne prouvent rien par elles-mêmes » appliqué aux revendications d'efficacité talismanique ; deux avenues instruites, aucun verdict rendu
- [[doctrinal/discernement/2026-08-13_shams-al-maarif-sihr-grille-contre-initiation-pseudo-initiation|Le statut du siḥr dans le Shams al-Maʿārif face à la grille guénonienne contre-initiation/pseudo-initiation]] 🔍 (en cours, speculatif) — deuxième axe du même chantier ; parenté de statut (réel/négatif/confiné au psychique) entre siḥr et contre-initiation, signal lexical *sâher*/*siḥr* non validé comme équivalence, test de vigilance syncrétique pour toute réception contemporaine décontextualisée ; aucun verdict rendu
...
## VIII. L'Atelier (hors doctrine — `atelier/`)
...
étanchéité — hub propre au domaine : (cf. Domaine Réservé, fiche meta-index).*
