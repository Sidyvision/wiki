...
- [[doctrinal/discernement/2026-08-30_nadis-du-coeur-sentiers-sephirothiques-tiferet|Les nâdîs issues du cœur et les sentiers séphirothiques émanant de Tiferet]] 🔍 (en cours, `speculatif`) — hypothèse de Sidy (2026-08-30) ; deux appuis réels (voies rapprochées de voies, et le cœur déjà posé des deux côtés — Tiferet est « Cœur de l'Arbre » dans le dépôt), trois obstacles (Guénon n'emploie ici qu'une litote, « pas sans analogie » ; deux centres du cœur à désambiguïser — *Anāhata* ou le lotus à huit pétales d'où sortent les 101 ; et **l'inversion du lettrique** — lettres sur les voies côté hébraïque, sur les centres côté sanscrit) ; **bloqué en amont** : les 22 sentiers ne sont pas documentés au dépôt et leur arrangement n'est pas fixé. Aucun comptage produit (Gizeh confronté, avertissement sur la pente des concordances chiffrées)
