...
- [[doctrinal/discernement/2026-07-27_septenaire-transversal-balance-degre-soleil|Le septénaire transversal, la Balance et le degré du Soleil — référentiels stellaires et états d'une même fonction]] 🔍 (en cours) : trois états d'une même fonction septénaire (polaire/écliptique/planétaire), chantier Guénon sur la Balance polaire/zodiacale, convergence quadruple sur degré 24 (Idrîs/Soleil/Hermès/Gizeh) ; volets *hozo* (Ourse→Pléiades, septénaire transversal) et *kari-kumi* (Balance, degré 24)
