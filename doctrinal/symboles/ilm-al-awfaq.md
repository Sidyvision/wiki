---
title: ʿIlm al-Awfāq (les carrés magiques) et la métaphysique du Nombre chez Ibn ʿArabī
type: symbole
status: traditionnel
...
# ʿIlm al-Awfāq (les carrés magiques) et la métaphysique du Nombre
...
> provient d'une **reconstruction par persona IA** (« la conversation source »,
> formule reprise ici jusqu'à ce jour), non d'une vérification sur texte primaire
> d'Ibn ʿArabī. Conformément à la discipline des sources (CLAUDE.md racine §VII :
> « dires d'un persona IA… réputés reconstruction plausible — utilisables comme
> piste, jamais comme source »), le marqueur `to-source` est réintroduit en
> frontmatter. La levée de ce marqueur exige la vérification du texte primaire
> par Sidy lui-même (ou la citation exacte d'une autorité textuelle contrôlée) —
> jamais sur la seule foi d'un modèle. Tant qu'elle n'est pas levée, le
> rapprochement avec Ibn ʿArabī reste une **piste**, non un fait établi.

## Concepts liés

- [[doctrinal/symboles/ilm-al-huruf]] — page existante du wiki, à enrichir avec ce développement sur les carrés magiques et la métaphysique akbarienne du nombre.
- [[doctrinal/autorites/ahmad-al-buni]], [[doctrinal/sources/shams-al-maarif]] — déjà documentés.
- [[doctrinal/autorites/ibn-arabi]].
