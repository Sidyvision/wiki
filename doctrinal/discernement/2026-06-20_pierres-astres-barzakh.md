...
> Conversation source : « Signification pierre de jade » (export ChatGPT, 2025-03-18, 48 messages).
...
> - *Filiation orthodoxe possible* : l'existence d'une science traditionnelle des correspondances entre minéraux, astres et qualités spirituelles est réelle et attestée — notamment chez Aḥmad al-Būnī (*Shams al-Maʿārif*), déjà identifié comme source potentielle par Sidy lui-même. Le cadre du Barzakh comme lieu d'interpénétration entre *ʿālam al-amr* et *ʿālam al-khalq* est doctrinalement légitime chez Ibn ʿArabī. Voir [[doctrinal/symboles/barzakh]] et [[doctrinal/autorites/ahmad-al-buni]].
> - *Parenté hétérodoxe possible* : aucune dérive doctrinale au sens strict (le cadre général invoqué est authentiquement traditionnel), mais une **méthode de validation problématique** — voir Examen formel.
>
...
- [[doctrinal/discernement/2026-06-20_visions-centre-nocturne]] — l'expérience du rayon doré, enrichie ici de détails supplémentaires (fluide bleu-turquoise scintillant, son de volée d'oiseaux) à intégrer dans cette fiche.
- [[doctrinal/autorites/ahmad-al-buni]] — source à vérifier directement plutôt que via les citations de la conversation.
- À surveiller : motif récurrent de validation catégorique non hedgée par l'IA d'origine face à des hypothèses explicitement présentées comme intuitives par Sidy lui-même (cf. également la fiche sur la « signalétique spirituelle », #73).
