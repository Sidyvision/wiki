...
tags: [discernement, en-cours, gematrie, non-syncretisme, validation-non-hedgee]
created: 2026-06-20
updated: 2026-06-20
...
> - *Parenté hétérodoxe possible* : la fusion de ces trois cadres (védique, soufi, tantrique) en un schéma psycho-spirituel unique — notamment l'assimilation de Vritra à « l'aspect inférieur de la Kundalini non éveillée » — mélange une cosmologie polythéiste (Indra, dieu du Veda), une anthropologie soufie (*nafs*, *qalb*) et une physiologie subtile tantrique (Kundalini) sans cloisonnement, exactement la démarche déjà signalée comme problématique dans [[doctrinal/symboles/merkavah-muraqaba]]. La méthode gématrique employée pour « confirmer » ces liens (réduction de différences numériques rapprochées a posteriori de termes choisis) est non falsifiable : n'importe quel couple de termes peut recevoir un rapprochement numérique post hoc.
>
...
- [[doctrinal/symboles/asma-al-husna]] — les Noms divins (*al-Fattāḥ*, *al-Nūr*) mobilisés dans la partie gématrique.
- À surveiller : ce type de construction comparatiste-gématrique semble être une démarche intellectuelle récurrente et appréciée par Sidy (cf. aussi #29) — utile de la signaler comme motif personnel transversal plutôt que de la retraiter isolément à chaque occurrence future dans le corpus restant.
