...
Au fil d'un échange sur une modélisation ancienne du monde comme disque cerclé d'une
chaîne de montagnes périphérique, Sidy formule l'intuition suivante : ce modèle et le
modèle sphérique centré sur une montagne axiale ne sont pas contradictoires mais relèvent
