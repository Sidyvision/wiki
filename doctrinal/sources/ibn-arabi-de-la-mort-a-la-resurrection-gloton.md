---
title: "De la mort à la résurrection — Ibn ʿArabī (trad. Maurice Gloton, Albouraq)"
type: source
status: traditionnel
...
Le texte est issu du **chapitre 198** des *Futūhāt*, intitulé « Sur la connaissance
du Souffle (*nafas*) », sections 11 à 38. Gloton le présente ici dans une traduction
annotée avec des diagrammes originaux. La note 13 (p. 35) précise qu'il a également
traduit une partie du même chapitre 198 dans son ouvrage *Jésus, le Fils de Marie dans
le Coran et selon l'enseignement d'Ibn ʿArabī* (Albouraq, Beyrouth, 2006, pp. 466–470).
...
| N° | Lettre | Nom Divin | Degré cosmique |
|---|---|---|---|
| 11 | ء (hamza) | *al-Badīʿ* l'Innovateur | Intellect premier (*ʿaql awwal*) — Calame suprême (*qalam al-aʿlā*) |
| 12 | ه (hāʾ) | *al-Bāʿith* l'Éveilleur | Âme universelle (*nafs kulliyya*) — Table préservée (*lawḥ maḥfūẓ*) |
| 13 | ع (ʿayn) | *al-Bāṭin* l'Intérieur | Nature universelle (*ṭabīʿa*) |
| 14 | ح (ḥāʾ) | *al-Ākhir* le Dernier | Substance primordiale indifférenciée (*jawhar ḥabāʾī*) |

### Section 3 — « Les mondes intermédiaires » — Jabarūt (degrés 15–18, pp. 37–38)

| N° | Lettre | Nom Divin | Degré cosmique |
|---|---|---|---|
| 15 | غ (ghayn) | *azh-Ẓāhir* l'Extérieur | Corps universel (*jism kullī*) |
| 16 | خ (khāʾ) | *al-Ḥakīm* le Sage | Conformation cosmique (*shakl*) |
| 17 | ق (qāf) | *al-Muḥīṭ* l'Enveloppant | Trône divin (*ʿarsh*) |
| 18 | ك (kāf) | *ash-Shakūr* le Reconnaissant | Piédestal (*kursī*) |
...
|---|---|---|---|---|---|
| 19 | ج (jīm) | *al-Ghaniyy* | Sphère sans étoiles (*falak al-atlas* / *falak al-burūj*) | — | — |
| 20 | ش (shīn) | *al-Muqaddir* | Sphère des étoiles fixes (*falak al-kawākib*) | — | — |
| 21 | ي (yāʾ) | *ar-Rabb* | Saturne (*zuḥal*) | Abraham | Samedi |
| 22 | ض (ḍād) | *al-ʿĀlim* | Jupiter (*mushtarī*) | Moïse | Jeudi |
| 23 | ل (lām) | *al-Qāhir* | Mars (*mirīkh*) | Aaron | Mardi |
| 24 | ن (nūn) | *an-Nūr* | Soleil (*shams*) / Idrīs | Idrīs (Enoch) | Dimanche |
| 25 | ر (rāʾ) | *al-Muṣawwir* | Vénus (*zuhra*) | Joseph | Vendredi |
| 26 | ط (ṭāʾ) | *al-Muḥṣī* | Mercure (*ʿuṭārid*) | Jésus | Mercredi |
| 27 | د (dāl) | *al-Mubīn* | Lune (*qamar*) | Adam | Lundi |

### Sections 5–7 — Nāsūt / Mulk (degrés 28–38, p. 40)

| N° | Lettre | Nom Divin | Degré cosmique |
|---|---|---|---|
| 28 | ت (tāʾ) | *al-Qābiḍ* | Feu (*nār*) |
| 29 | ز (zāy) | *al-Ḥayy* | Air (*hawāʾ*) |
| 30 | س (sīn) | *al-Muḥyī* | Eau (*māʾ*) |
| 31 | ص (ṣād) | *al-Mumīt* | Terre (*ʿarḍ*) |
| 32 | ظ (ẓāʾ) | *al-ʿAzīz* | Minéraux (*maʿādin*) |
| 33 | ث (thāʾ) | *ar-Razzāq* | Végétaux (*nabāt*) |
| 34 | ذ (dhāl) | *al-Mudhhil* | Animaux (*ḥayawān*) |
| 35 | ف (fāʾ) | *al-Qawiyy* | Anges (*malāʾika*) |
| 36 | ب (bāʾ) | *al-Laṭīf* | Djins (*jinn*) |
| 37 | م (mīm) | *al-Jāmiʿ* | L'Homme (*insān*) |
| 38 | و (wāw) | *Rafīʿ ad-Darajāt* | L'Homme parfait (*insān kāmil*) — synthèse de tous les degrés antérieurs |

### Table complémentaire — 28 Manāzil al-Qamar (pp. 45–48)

Le texte contient (p. 45) la table explicite intitulée :
« *Les 12 signes du Zodiaque, les 28 Mansions cosmiques, les 28 lettres de
l'alphabet arabe et les Noms divins correspondants* »

Principe posé par Ibn ʿArabī : les 28 lettres sont classées *selon l'ordre naturel
de leur point d'émission dans l'appareil phonatoire*. L'anatomie de la parole = l'anatomie du cosmos.

La table complète lettre × Nom Divin × Manzil × Signe zodiacal est transcrite
dans [[table-28-degres-nafas-rahman]].

## Point doctrinal central — Principe phonatoire (p. 45)

*« Les 28 lettres ont été classées par Ibn ʿArabī selon l'ordre naturel de leur
point d'émission dans l'appareil phonatoire en correspondance avec les 28 mansions
cosmiques. »*

La progression va du plus profond (hamza = glotte = Intellect premier) au plus
extérieur (wāw = lèvres = Homme parfait). Ce principe est la clé de toute la table.

## Note sur le *ʿUqlat al-mustawfiz* (note 15, p. 40)

Ibn ʿArabī a traité la même hiérarchie dans le *ʿUqlat al-mustawfiz*
(« L'entrave qui retient le partant ») selon une présentation différente
(5 Trônes selon 5 dénominations coraniques). Édition Nyberg, *Kleinere
Schriften des Ibn Al-ʿArabī*, Leiden, 1919, pp. 39–99.

## Validation doctrinale

Table complète validée par le Gem René Guénon comme **CORRESPONDANCE ÉTABLIE**
(2026-07-01). Voir [[table-28-degres-nafas-rahman]] pour la table intégrale et
les directives d'inscription dans le wiki-manifest v0.2.1.

## Concepts liés

- [[table-28-degres-nafas-rahman]] — table complète dérivée de cette source
- [[nafas-rahmani]] — doctrine du Souffle, 28 (+ 10) degrés
- [[manazil-al-qamar]] — les 28 Demeures lunaires, mappées ici
- [[hadarat-khams]] — les cinq Présences divines, macro-structure
- [[ilm-al-huruf]] — science des lettres, principe phonatoire
...
## ADDENDUM 1 — Degrés 17-38 et modes 39-50 (lot 3)

## Transcription — chapitre 198, degrés 17 à 38 (pp. 38-41)
...
*Fin de l'addendum. Portée exacte : ces pages sourcent les colonnes Lettre / ciel /
jour / prophète siégeant des degrés 21-27 (levée partielle du to-source) et
confirment les degrés 17-20 et 28-38. Elles ne donnent PAS, pour ces degrés, les
colonnes Nom Divin, Faṣṣ, Manzil — qui restent `to-source` (à confronter aux tables
correspondantes du ch. 198 / Meftah).*
...
## ADDENDUM 2 — Noms Divins et Manāzil (lot 4)

## Transcription — tableau des correspondances, degrés 18 à 31 (pp. 46-47)
...
**Structure remarquable du tableau (constat de forme, pas d'interprétation)** : la
colonne des signes procède par fractions — chaque signe zodiacal couvre 2⅓ demeures
(28 demeures / 12 signes), d'où les mentions (1), (1/3), (2/3) et les chevauchements
de signe en fin de série (degrés 20, 22, 27, 29). Les dates données par Gloton
suivent le découpage 21 du mois à 20 du mois suivant.


*Portée exacte : ces pages sourcent les colonnes **Nom Divin** et **Manzil** (avec
racines et portions zodiacales) des degrés 18 à 31 — dont les degrés 21-27, dernier
reliquat du to-source de la table. Les degrés 11-17 et 32-38 ne figurent pas sur ces
pages (pp. 44-45 et 48 vraisemblablement) : si la fiche
`table-28-degres-nafas-rahman` ne les porte pas déjà, ils restent to-source.*

---

## ADDENDUM 3 — Degrés 11-17 et 32-38 (lot 5)

## En-tête du tableau (p. 45)

Titre : « Les 12 signes du Zodiaque, les 28 Mansions cosmiques, les 28 lettres de
l'alphabet arabe et les Noms divins correspondants ».

Encadré introductif : « Les 28 lettres de l'alphabet ont été classées, par Ibn
ʿArabî, selon l'ordre naturel de leur point d'émission dans l'appareil phonatoire,
en correspondance avec les 28 mansions cosmiques. Aux 12 signes du Zodiaque
correspondent 28 mansions, soit 2 mansions 1/3 par signe. »

Contexte (p. 44) : ce tableau synoptique a été élaboré par Gloton pour faciliter la
lecture des sections 18, 19 et 20 du chapitre 198, permettant de situer Paradis et
Enfers dans l'analyse d'Ibn ʿArabî (en particulier à la section 20).
...
> **Remarque de cohérence (constat de forme)** : le Nom Divin du degré 38 — *Rafîʿ
> ad-Darajât*, « l'Élévateur des degrés » — pour l'Homme parfait, synthèse de tous
> les degrés antérieurs (p. 40), et convergence remarquable avec la fonction du
> nœud traversant dans l'architecture de l'Instrument. Constat de forme, pas
> d'interprétation.

## Note d'édition capitale (p. 49, note 16)

L'édition arabe des *Futūḥāt* utilisée par Gloton pour les citations du chapitre
198 : **Tome 4, pages 29 à 32/9 — Éditions Dar al-Kotob al-Ilmiyah, Beyrouth,
Liban, 1420/1999**. (Note 17 : références aux versets 18-109 et 31-27 pour les
« Paroles de Dieu qui ne s'épuisent pas ».)

La p. 49 amorce en outre les citations discursives du ch. 198 (les réalités
existenciées comme Paroles de Dieu, la Réalité de Jésus, Qurʾân 4-171) — matière
pour l'ingest du récit eschatologique déjà au backlog, hors du périmètre du
présent addendum.


*Portée : avec les addenda précédents, les degrés **11 à 38** sont intégralement
sourcés (Lettre, Nom Divin, réalité, Manzil, signe). Le to-source du tableau
synoptique est entièrement levé. Les degrés 1-10 (Hāhūt, formules divines
pré-lettrées) relèvent d'une autre section, déjà transcrite dans la fiche.*
